<template>
    <div class="home-center-nav-div">
        <a :key="index" href="#" v-for="(h,index) in footerNav.homeNav" class="home-center-nav-a"><img :src="h" alt=""></a>
    </div>
</template>

<script>
    export default {
        name: "home-center-nav",
        data () {
            return {
                footerNav:{
